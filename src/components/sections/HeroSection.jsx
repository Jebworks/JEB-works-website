...
const HeroSection = ({ sectionRef, counter, scrollToSection }) => {
  ...
  return (
    ...
    >
      ...
      {/* === 3. Main Content === */}
      {/* UPDATED PADDING: 
          - Reduced pt-24 to pt-20 (5rem) -> Matches navbar height exactly
          - Reduced md:pt-24 to md:pt-20 (5rem) -> Matches navbar height exactly
      */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-0 pb-12 md:pt-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative order-1 lg:order-2 flex justify-center lg:justify-end animate-on-scroll">
            <div className="relative flex items-center justify-center">
              {/* Decorative Circle */}
              <div 
                // UPDATED: Increased mobile size from w-[330px] to w-[380px]
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[380px] h-[380px] md:w-[450px] md:h-[450px] rounded-full -z-10"
                style={{
              ...
              {/* Hero Image */}
              {/* UPDATED: Increased mobile max-width from max-w-[350px] to max-w-[400px] */}
              <div className="relative z-10 w-full max-w-[400px] md:max-w-[500px] lg:max-w-[650px]">
                <img 
                  src="hero.png" 
                  alt="App Preview" 
