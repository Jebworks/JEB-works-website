...
const HeroSection = ({ sectionRef, counter, scrollToSection }) => {
  ...
  return (
    ...
    >
      {/* === 1. Background Layer (Reverted to Dark Theme) === */}
      <div 
      ...
      {/* === 2. Animated Orbs (Subtle Dark Mode Accents) === */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-12 md:pt-12">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative order-1 lg:order-2 flex justify-center lg:justify-end animate-on-scroll">
            ...
            {/* Wrapper to center image and background */}
            <div className="relative flex items-center justify-center">
              
               {/* DECORATIVE CIRCLE (Background) - UPDATED COLOR */}
              <div 
                ...
                style={{
                  // Light Weight Color: Soft Cream/Peach Gradient
                  background: 'linear-gradient(135deg, hsl(36, 33%, 96%), hsl(42, 55%, 90%))', 
                  opacity: 0.9,
                  filter: 'blur(40px)'
                }}
              />
