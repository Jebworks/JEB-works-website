...
const HeroSection = ({ sectionRef, counter, scrollToSection }) => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: "linear-gradient(rgba(15, 10, 30, 0.9), rgba(15, 10, 30, 0.9)), url('https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80')",
