...
import { Shield, Zap, BarChart3, Smartphone, ArrowRight, PlayCircle } from 'lucide-react';
...
const PrimaryButton = ({ children, className = '', ...props }) => (
  <button
    ...
    style={{
      background: 'linear-gradient(90deg, hsl(18, 60%, 45%), hsl(42, 55%, 55%))',
      color: 'hsl(36, 33%, 98%)',
...
const HeroSection = ({ sectionRef, counter, scrollToSection }) => {
  ...
  return (
    <section
      ...
      style={{
        // FIX: Reduced minHeight because global padding already adds 5rem spacing
    ...
    >
      ...
      <div 
        ...
        style={{
          // Deep Earthy Charcoal to Rich Clay gradient
      ...
      {/* Main content */}
      {/* FIX: Reduced top padding from pt-24 to pt-12 to balance with global padding */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative order-1 lg:order-2 flex justify-center lg:justify-end animate-on-scroll">
            ...
            <div 
              ...
              style={{
                background: 'linear-gradient(135deg, hsl(160, 30%, 45%), hsl(160, 30%, 35%))', // Sage Green Accent
                opacity: 0.8,
              }}
            />

            {/* HERO IMAGE (Foreground)
                Updated path to hero.png
            */}
            <div className="relative z-10 w-[280px] md:w-[400px] lg:w-[450px]">
              <img 
                src="hero.png" 
                alt="App Preview" 
                className="w-full h-auto object-contain drop-shadow-2xl transform hover:scale-105 transition-transform duration-500"
                style={{
                   // Using mask to fade bottom slightly if image is cut off, optional
                   maskImage: 'linear-gradient(to bottom, black 90%, transparent 100%)',
                   WebkitMaskImage: 'linear-gradient(to bottom, black 90%, transparent 100%)' 
                }}
              />
              
              {/* Floating Card Decoration (On Top of Image) */}
              <div 
