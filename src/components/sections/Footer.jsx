...
import { IndianRupee, Linkedin, Instagram, Twitter, ShieldCheck } from 'lucide-react';

/**
 * Footer Component
 *
 * Design:
 * - Layout: 6-column grid (2 for brand, 4 for links).
 * - Theme: Dark Mode (Black background + Gold accents).
 * - Content: Site navigation (Anchors) and trust indicators.
 */
const Footer = () => {
          ...
          <div className="lg:col-span-2 flex flex-col items-start animate-on-scroll">
            ...
            <div className="flex items-center gap-2 mb-6">
              <div
                ...
                style={{ 
                  backgroundColor: 'hsl(18, 60%, 20%)', // Dark clay
                  color: 'hsl(18, 100%, 80%)' // Light clay icon
                }}
              >
                <IndianRupee size={20} />
              </div>
