...
const Footer = () => {
  // Gold/Saffron highlight color for consistency (used for accents like Shield)
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-16">
          ...
          <div className="lg:col-span-2 flex flex-col items-start animate-on-scroll">
            ...
            <div className="flex items-center gap-0 mb-6">
              ...
              />
              {/* Updated Text Styles to match Navigation Branding */}
              <span className="text-2xl md:text-3xl font-black tracking-tight ml-2">
