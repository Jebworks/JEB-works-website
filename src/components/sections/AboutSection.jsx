 ...
 * Layout: Image Left (Fixed Pixel Height) | Content Right (Glass Card)
 * Theme: Light Mode (bg-background)
 */
const AboutSection = ({ sectionRef }) => {
  // Reusable "Glass" style optimized for the Light Background (Only used for right column now)
  const glassStyle = {
    background:
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 mb-20 items-center">
          {/* === LEFT COLUMN: Image Section === */}
          <div className="animate-on-scroll w-full">
            <div className="relative h-[600px] w-[80%] mx-auto rounded-3xl overflow-hidden shadow-xl group">
              {/* Image */}
              <img
                src="about.png"
                alt="Jeb Works Team"
                className="transition-transform duration-700 object-contain object-center w-full h-full"
              />
          ...
          >
            <div
              className="h-full p-6 sm:p-8 md:p-10 rounded-3xl transition-all duration-700 hover:-translate-y-3 flex flex-col justify-center relative overflow-hidden"
              style={glassStyle}
            >
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-6 text-muted-foreground">
                  <p className="leading-relaxed text-base sm:text-lg group-hover:text-foreground transition-colors duration-300">
                  ...
                  <p className="leading-relaxed text-base sm:text-lg group-hover:text-foreground transition-colors duration-300">
                    ...
                    <strong className="text-primary">Google Play Store</strong>{" "}
                    and the{" "}
                    <strong className="text-primary">Apple App Store</strong>.
                    Our goal is to deliver a smooth, user-friendly experience
                    from day one, and we're excited to bring this powerful tool
                    to users across India and beyond.
                  </p>
                </div>
              </div>
